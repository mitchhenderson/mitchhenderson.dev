...
TODO: Surprising data far outside of expectations increases uncertainty (another benefit?)
...
This gives me `r nrow(sim_data)` simulated max rep sets across the 30 athletes. 10 picked at random look like this:
