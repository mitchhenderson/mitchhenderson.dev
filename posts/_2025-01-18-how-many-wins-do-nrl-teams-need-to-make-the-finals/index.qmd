...
This draw now needs results for each match. To do this we need to make an assumption about how we can most realistically generate results for matches between these teams. The points differential between teams in a match determines who wins and loses

I need a measure of each teams strength. This gives us a way to weight the probability of one team winning against another. There are many ways to approach this, but for simplicity I will just use the Sportsbet betting odds for winning the 2025 competition.
