...
I scraped 10 seasons of match result data from Wikipedia.[^2]

[^2]: I might do a follow up post about how I did this. Let me know if you'd be interested.

```{r}
#| output: false

# Import match results for 10 seasons (up to 2024)
import <- read_csv("2014-2024_nrl_match_results.csv")
```
...
I calculated the points differential for each match and created binary indicator columns for the winning/losing team and draws. The distribution of points differentials is interesting.
