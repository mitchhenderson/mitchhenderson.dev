...
date: 2026-01-04
image: /img/1rm_curve_thumbnail.png
draft: false
filters: [details]
format:
  html:
...
To demonstrate this point, I'll just show three athletes: one with high endurance (Athlete `r selected_athletes[3]`), one with low endurance (Athlete `r selected_athletes[1]`), and one in the middle (Athlete `r selected_athletes[2]`).
