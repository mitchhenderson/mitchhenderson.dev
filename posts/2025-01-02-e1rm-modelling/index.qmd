...
## ![](https://www.r-project.org/logo/Rlogo.svg){height=25}
```{r}
#| output: false
...
## ![](https://s3.dualstack.us-east-2.amazonaws.com/pythondotorg-assets/media/files/python-logo-only.svg){height=30}
